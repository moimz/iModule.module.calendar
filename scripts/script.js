...
var Calendar = {
	...
	edit:function(event) {
		...
		iModule.modal.get(ENV.getProcessUrl("calendar","getModal"),{modal:"edit",uid:event.uid,rid:event.rid},function($modal,$form) {
			Calendar.init($modal,$form);
			return false;
		});
	},
